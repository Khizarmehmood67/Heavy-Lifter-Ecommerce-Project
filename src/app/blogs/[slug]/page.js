import BlogsDetailPage from "@/components/partial-pages/blogsDetail";
...
export async function generateMetadata({ params }) {
  const { slug } = params;
  const response = await SEO.getBlogPage(slug);
...
const BlogsDetialPage = ({ params }) => {
  return <BlogsDetailPage id={params?.slug} />;
};

export default BlogsDetialPage;
